...
import {
  ChatContactClickHandler,
  CONTACT_CLICK_HANDLER_TOKEN,
} from "../../services/chat-contact-click-handler";
import {
  ChatListStateService,
  ChatWindowState,
} from "../../services/chat-list-state.service";
...
export class ChatWindowComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    const messages$: Observable<RoomMessage | Message> =
      this.chatWindowState.recipient.messages$;
    messages$
      .pipe(
